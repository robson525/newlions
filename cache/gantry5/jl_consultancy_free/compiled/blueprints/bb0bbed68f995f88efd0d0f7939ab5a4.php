...
return [
    ...
    'data' => [
        'items' => [
            ...
            'styles.abovefooter.background' => [
                'type' => 'input.colorpicker',
                'label' => 'Background',
                'default' => '#262829',
                'name' => 'styles.abovefooter.background'
            ],
            'styles.abovefooter.text-color' => [
                'type' => 'input.colorpicker',
                'label' => 'Text',
                'default' => '#cacaca',
                'name' => 'styles.abovefooter.text-color'
            ],
            'styles.accent' => [
                'type' => '_root',
                'form_field' => false,
        ...
        'nested' => [
            ...
            'styles' => [
                'abovefooter' => [
                    'background' => 'styles.abovefooter.background',
                    'text-color' => 'styles.abovefooter.text-color'
                ],
                'accent' => [
