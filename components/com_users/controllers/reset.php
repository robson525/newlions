...
class UsersControllerReset extends UsersController
{
	...
	public function request()
	{
		...
		else
		{
			...
			// Proceed to step two.
			$message = 'Uma mensagem foi enviada para o email ' . $return . '. Ela contém um código de verificação';
			$this->setRedirect(JRoute::_('index.php?option=com_users&view=reset&layout=confirm', false), $message, 'success');
