...
class UsersModelReset extends JModelForm
{
	...
	public function processResetRequest($data)
	{
		...
		if (empty($userId))
		{
			$this->setError(JText::_('COM_USERS_INVALID_CPF'));
		...
		$mail = new Email();
		$mail->setDestinatario($user->email, $user->name);
		$mail->recuperarSenha($subject, $body);
		...
		{
			//return $user->email;
			//die($mail->getError() . '<br>' . $data['link_text']);
