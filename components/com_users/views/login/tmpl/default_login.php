  ...
  <div class="g-block size-50">
    <div class="text-center">
      ...
      <div class="reg-login-form-wrap">
        ...
        <div class="login<?php echo $this->pageclass_sfx ?>">
          ...
          <?php endif; ?>
          <?php if (($this->params->get('logindescription_show') == 1 && str_replace(' ', '', $this->params->get('login_description')) != '') 
          ...
          <form action="<?php echo JRoute::_('index.php?option=com_users&task=user.login'); ?>" method="post" class="form-validate">
            ...
            $this->form->setFieldAttribute('username', 'hint', 'CPF');
            $this->form->setFieldAttribute('username', 'label', 'CPF');
            $this->form->setFieldAttribute('username', 'maxlength', '11');
        ...
        <?php endif; ?>
        <div class="form-group">
          <button type="submit" class="button button-3 btn-block">
    ...
    <div class="form-links row">
      <div class="span5">      
        ...
        <div class="span5">
          <a href="<?php echo JRoute::_('index.php?option=com_users&view=registration', false); ?>">
...
<?php //var_dump($this->form->getFieldset('credentials')['username']); ?>